...
<div class="container">
<div>
    <h4 class="text-white">Please update your Room information below:</h2>
</div>

<form action="/updateRoom" class="row" method="post">
    @csrf
    <div class="col-10">
    ...
    @endif
    <div class="col-10">
        <button class="btn btn-md btn-warning text-white" type="submit">Confirm Updates</button>
    </div>
</form>
